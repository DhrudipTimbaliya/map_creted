...
import '../../project_specific/direction_step_seet.dart'; // for TravelModeData if needed

typedef LatLngFromAddress = Future<LatLng?> Function(String address);

class WalkRouteController extends GetxController {
  ...
  /// Calculates a walking route and returns RouteInfo.
  Future<RouteInfo> getRoute({
    ...
    final steps = rawSteps
      ...
      maneuver: (s['maneuver'] ?? 'straight') as String,
    ))
        .toList();
